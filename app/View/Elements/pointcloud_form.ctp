...
<section class="wrapper style4 container">
	<div class="content">
		<section>
			<header>
				<h3>Enter the Point Cloud Information Below</h3>
			</header>
			<?php
			echo $this->Form->create('Pointcloud');
			if (isset($edit) && $edit) {
			...
			<div class="row">
				<section class="6u">
					<?php echo $this->Form->input('topic', array('label' => 'Topic')); ?>
				</section>
				<section class="6u">
			...
			<div class="row">
				<section class="6u">
					<?php echo $this->Form->input('stream', array('label' => 'Stream (optional)')); ?>
				</section>
				<section class="6u">
					<?php echo $this->Form->input('tf_frame', array('label' => 'TF Frame (optional)')); ?>
				</section>
			</div>
			<div class="row">
				<section class="12u">
